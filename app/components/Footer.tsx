...
const socialLinks = [
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/texasaerialrobotics/',
    icon: (
      <svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor">
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <p style={{ fontSize: '14px', lineHeight: 1.7, maxWidth: '280px', marginTop: '16px' }}>
              Designing, building, and programming fully autonomous drones at UT Austin.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ fontSize: '14px', marginBottom: '20px', lineHeight: 1.7 }}>
              Help us push the boundaries of autonomous flight.
            </p>
            <a
        ...
        <div className="footer-bottom">
          <p style={{ margin: 0 }}>
            &copy; {new Date().getFullYear()} Texas Aerial Robotics. All rights reserved.
          </p>
          <p style={{ margin: 0 }}>
